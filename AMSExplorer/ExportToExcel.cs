        ...
        private async Task Excel_DoWorkAsync(CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (radioButtonAllAssets.Checked)
                {
                    ...
                    {
                        var output = await ExportAssetExcelAsync(asset, row, detailed, checkBoxLocalTime.Checked, selist);
        ...
        private async Task CSV_DoWorkAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (radioButtonAllAssets.Checked)
                {
                    ...
                    {
                        var res = await ExportAssetCSVLineAsync(asset, detailed, checkBoxLocalTime.Checked, selist);
